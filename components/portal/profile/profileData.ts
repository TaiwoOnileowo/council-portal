...
export const mockReviews: UserReview[] = [
  {
    ...
    vendorLogo:
      "https://ui-avatars.com/api/?name=Swift+Move&background=3b82f6&color=fff&size=128&bold=true&format=png",
    rating: 5,
    comment:
  ...
  },
  {
    ...
    vendorLogo:
      "https://ui-avatars.com/api/?name=Campus+Link&background=ef4444&color=fff&size=128&bold=true&format=png",
    rating: 4,
    comment:
  ...
  },
  {
    ...
    vendorLogo:
      "https://ui-avatars.com/api/?name=Uni+Ride&background=10b981&color=fff&size=128&bold=true&format=png",
    rating: 5,
    comment:
