            ...
            bookings.map((booking) => {
              ...
              return (
                <button
                  ...
                  className="w-full flex items-center gap-3.5 px-5 py-3.5 border-b border-portal-border last:border-b-0 hover:bg-portal-accent-bg/50 transition-colors text-left"
                >
                  <div
